...
UVDAT_ENABLE_NETWORK_RECOVERY: bool = env.bool("DJANGO_UVDAT_ENABLE_NETWORK_RECOVERY", default=True)
UVDAT_ENABLE_GEOAI_SEGMENTATION: bool = env.bool(
    "DJANGO_UVDAT_ENABLE_GEOAI_SEGMENTATION", default=True
)
